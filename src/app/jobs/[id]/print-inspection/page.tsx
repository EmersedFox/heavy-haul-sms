    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {failItems.map(item => (
        <div key={item} className="p-3 bg-red-50 border border-red-100 rounded print:border-red-300 break-inside-avoid">
          ...
          {/* NEW: Display the Note if it exists */}
      ...
      {/* SECTION 2: PASSED ITEMS (Green - 2 Columns) */}
      <div className="mb-8">
        ...
        {/* THE 2-COLUMN GRID (Works on Screen and Print) */}
      ...
      {/* FOOTER */}
      <div className="mt-12 pt-8 border-t border-slate-200 text-center text-sm text-slate-400 print:fixed print:bottom-0 print:w-full">
        <p>Heavy Haul Auto Service LLC • 317-555-0100</p>
